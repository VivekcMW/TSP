...
export function HowItWorks() {
  return (
    <section id="how-it-works" className="py-20 lg:py-28 bg-muted/30" data-testid="section-how-it-works">
        ...
        <div className="space-y-24">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <h3 className="text-2xl sm:text-3xl font-bold">Tell us who you are.</h3>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 order-1 lg:order-2">
              ...
              <h3 className="text-2xl sm:text-3xl font-bold">Your Social Inbox comes alive.</h3>
              <p className="text-muted-foreground">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <h3 className="text-2xl sm:text-3xl font-bold">AI drafts insights in your POV.</h3>
              <p className="text-muted-foreground">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 order-1 lg:order-2">
              ...
              <h3 className="text-2xl sm:text-3xl font-bold">Publish with one click.</h3>
              <p className="text-muted-foreground">
